...
class OptimizedCacheManagerTest {
    ...
    void processShouldCallOriginDataIfInvalidCachedData() throws Throwable {
        ...
        BDDMockito.given(valueOperations.get("testType::1::param")).willReturn(cachedData);
        ...
        // then
        assertThat(result).isEqualTo(originDataSupplier.get());
        BDDMockito.verify(valueOperations).set(eq("testType::1::param"), anyString(), any(Duration.class));
    }
    ...
    void processShouldReturnCachedDataIfNotExpiredLogically() throws Throwable {
        ...
        BDDMockito.verify(valueOperations, never()).set(eq("testType::1::param"), anyString(), any(Duration.class));
    }
